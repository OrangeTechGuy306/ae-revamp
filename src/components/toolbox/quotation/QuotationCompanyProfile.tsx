            ...
            <div className="cardContainer">
                <div className="mainContent">
                    ...
                    <div className="rightSide">
                        <h3 style={{ color: '#044381', fontSize: '18px', marginBottom: '14px', marginTop: '20px' }}>Services & Technical Capabilities</h3>
                        ...
                        <div style={{ border: '1px solid #e9eef5', borderRadius: '12px', padding: '14px', marginBottom: '10px', background: '#fcfdff' }}>
                            <h4 style={{ color: '#0aa80f', fontSize: '14px', marginBottom: '6px' }}>Solar Home & Office Systems</h4>
                            <p style={{ fontSize: '12px', color: '#333', marginBottom: '8px' }}>Design and installation of hybrid/off-grid systems with inverters, batteries, solar panels, and smart monitoring for seamless power supply.</p>
                        </div>

                        <div style={{ border: '1px solid #e9eef5', borderRadius: '12px', padding: '14px', marginBottom: '10px', background: '#fcfdff' }}>
                            <h4 style={{ color: '#0aa80f', fontSize: '14px', marginBottom: '6px' }}>Solar Street Lights</h4>
                            <p style={{ fontSize: '12px', color: '#333', marginBottom: '8px' }}>Automated solar streetlights with durable poles, energy-saving LEDs, and night-time optimization for urban and rural applications.</p>
                        </div>

                        <div style={{ border: '1px solid #e9eef5', borderRadius: '12px', padding: '14px', marginBottom: '10px', background: '#fcfdff' }}>
                            <h4 style={{ color: '#0aa80f', fontSize: '14px', marginBottom: '6px' }}>Mini-Grid & Off-Grid Power</h4>
                            <p style={{ fontSize: '12px', color: '#333', marginBottom: '8px' }}>Community electrification, industrial clusters, and farm solutions featuring hybrid solar-diesel systems and energy management technologies.</p>
                        </div>

                        <div style={{ border: '1px solid #e9eef5', borderRadius: '12px', padding: '14px', marginBottom: '10px', background: '#fcfdff' }}>
                            <h4 style={{ color: '#0aa80f', fontSize: '14px', marginBottom: '6px' }}>Electrical Installations</h4>
                            <p style={{ fontSize: '12px', color: '#333', marginBottom: '8px' }}>Professional wiring, breaker panels, load balancing, surge protection, and full compliance with national and international electrical codes.</p>
                        </div>

                        <div style={{ border: '1px solid #e9eef5', borderRadius: '12px', padding: '14px', marginBottom: '10px', background: '#fcfdff' }}>
                            <h4 style={{ color: '#0aa80f', fontSize: '12px', marginBottom: '6px' }}>Maintenance & Troubleshooting</h4>
                        ...
                        <div style={{ border: '1px solid #e9eef5', borderRadius: '12px', padding: '14px', marginBottom: '10px', background: '#fcfdff' }}>
                            <h4 style={{ color: '#0aa80f', fontSize: '12px', marginBottom: '6px' }}>Smart Home & Industrial Automation</h4>
                        ...
                        <h3 style={{ color: '#0aa80f', fontSize: '14px', marginBottom: '8px', marginTop: '16px' }}>Project Execution & Quality Assurance</h3>
                        <div style={{ marginBottom: '12px' }}>
                            <h4 style={{ color: '#044381', fontSize: '14px', margin: '0 0 8px 0' }}>Process Steps</h4>
                            <ul style={{ display: 'inline-block', textAlign: 'left', margin: 0, color: '#333', fontSize: '12px' }}>
                        ...
                        <h4 style={{ color: '#044381', fontSize: '14px', marginBottom: '8px' }}>Why Clients Trust Us</h4>
